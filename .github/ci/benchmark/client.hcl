...
cmd="./zig/zig build benchmark -Dcpu=x86_64_v3+aes -Doptimize=ReleaseSafe -- --account-count=10 --transfer-count=100_000_000 --transfer-count-per-second=1_000_000 --addresses=${var.addresses} --statsd --print-batch-timings"
